...
export default function List() {
    ...
    const getArticleCover = (article) => article.cover || article.featuredImage || defaultCover

    const getLocalizedField = useCallback((field) => {
        if (!field) return ''
    ...
    const goToArticle = (id) => navigate(`/articles/${id}`)
